...
const systemInstruction = `You are a Senior Agronomist specialized in tropical and temperate agriculture with expertise in plant disease diagnosis. Your goal is to provide accurate disease diagnosis, high-yield recovery strategies, and practical treatment schedules.
...
5. Create a practical 7-day treatment plan with specific daily actions
6. Recommend both organic and chemical solutions with specific active ingredients
7. Estimate yield impact if untreated
8. Include safety warnings about chemical handling
...
Always respond in valid JSON format with the following structure:
{
  ...
  "treatments": {
    ...
    "chemical": ["fungicide name with active ingredient", "dosage instructions"]
  },
  "yieldImpact": {
    "loss": 0-100,
...
`
    ...
    // Prepare content with images for REST API
    const content = {
      parts: [
        { text: contextPrompt },
